    ...
    <div className="details-container">
       <div className="container-fluid">
               <Link to="/circuitSelection/:id">
                <img className="close-box" src="https://img.icons8.com/windows/32/000000/macos-close.png" alt='close box'/>
                </Link>
       ...
       { moves &&  
         <ul className="move-content">
            ...
            <img className="check-icon" src="https://img.icons8.com/flat-round/30/000000/checkmark.png" alt='check mark icon'/>
